...
<body>
	<div class="addContainer">
		<form:form modelAttribute="itemAddFormData"
			action="${pageContext.request.contextPath}/item/add" method="post"
			encType="multipart/form-data">
			<h1>
				상품 등록 <a href="${pageContext.request.contextPath}/"><img
			...
			<table class="table table-borderless">
				...
				<tr>
					<td colspan="3"><textarea class="summernote" name="content"></textarea>
					</td>
				</tr>
			</table>
