...
<body>
	<div class="addContainer">
		<form:form>
			<h1>
				상품 디테일 <a href="${pageContext.request.contextPath}/"><img
					src="/images/eggPlant.png" width="70" height="70"></a>
			</h1>
			<hr />
			<c:if test="${loginSession eq member.email }">
				<input type="button"
					onclick="window.location.href='${pageContext.request.contextPath}/item/edit/${item.id }'"
					value="수정">&nbsp;
				<input type="button"
					onclick="window.location.href='${pageContext.request.contextPath}/item/delete/${item.id }'"
					value="삭제">
			</c:if>
				...
				<tr>
					<td colspan="2">
						<button type="button" class="btn_cart">
							<img src="/icons/wish.png" height="50" width="50">
						</button>&nbsp;&nbsp;&nbsp; <a
						href="${pageContext.request.contextPath}/kakao/pay/${item.id}"><img
							src="/images/kakao_pay.png"></a>&nbsp;&nbsp;&nbsp;
						<button type="button" id="payment-button">
							<img src="/images/toss_pay.png" height="50" width="100" />
						</button>&nbsp;&nbsp;&nbsp; <input type="button" class="btn btn-success"
						value="상품 문의"
						onclick="window.location.href='${pageContext.request.contextPath}/question/list/${item.id}'">
