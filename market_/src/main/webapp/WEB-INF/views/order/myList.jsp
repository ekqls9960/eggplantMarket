									...
									<c:forEach var="item" items="${readyItem }">
										<tr>
											...
											<td width="15%"><button
													...
													onclick="window.location.href='${pageContext.request.contextPath}/question/add/${item.id}'">상품
													문의</button></td>
											<td width="15%"><button
													class="round-black-btn small-btn">주문 취소</button></td>
								...
								<tbody>
									<c:forEach var="item" items="${shippingItem }">
										<tr>
											...
											<td width="15%"><button
													class="round-black-btn small-btn"
													onclick="window.location.href='${pageContext.request.contextPath}/order/confirm/${item.id}'">구매
													확정</button></td>
											<td width="10%" class="text-center"><a href="#"
												class="trash-icon"><i class="far fa-trash-alt"></i></a></td>
										</tr>
