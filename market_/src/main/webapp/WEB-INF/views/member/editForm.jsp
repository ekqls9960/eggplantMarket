...
<body>
	<div class="wrapper">
		<div class="container">
			...
			<form:form class="form-horizontal" modelAttribute="member"
				role="form" method="post"
				action="${pageContext.request.contextPath}/member/edit/${id }">
				...
				<div class="form-group" id="divNickname">
					...
					<div class="col-lg-5">
						<form:input path="nickname" class="form-control" id="nickname"
							value="${member.nickname }" data-rule-required="true"
							placeholder="별명" maxlength="15" required="required" />
				...
				<div class="form-group" id="divPhoneNumber">
					...
					<div class="col-lg-5">
						...
						<form:input path="phoneNum" class="form-control onlyNumber"
							value="${member.phoneNum }" id="phoneNumber"
						...
						<input type="hidden" name="currentPhoneNum"
				...
				<div class="form-inline-form-group">
					...
					<div class="col-lg-5">
						...
						<input type="button" class="btn btn-secondary btn-sm"
							onClick="execDaumPostcode()" value="우편번호 검색">
				...
				<div class="form-group">
					...
					<div class="col-lg-5">
						<form:input path="roadAddr" class="form-control"
							value="${member.roadAddr}" required="required" />
						&nbsp;
						<form:errors path="roadAddr" class="errorMsg" />
					</div>
				</div>
				<div class="form-group">
					<label for="detailAddr" class="col-lg-2 control-label">상세
						주소</label>
					<div class="col-lg-10">
						<form:input path="detailAddr" class="form-control"
							required="required" value="${member.detailAddr}" />
						&nbsp;
				...
				<div class="form-group" id="divPassword">
					<label for="inputPassword" class="col-lg-2 control-label">현재
						비밀번호</label>
					<div class="col-lg-5">
						<input type="password" class="form-control" id="password"
							name="currentPwd" data-rule-required="true" placeholder="패스워드"
							maxlength="30">
						<form:errors path="currentPwd" class="errorMsg" />
					</div>
				</div>
				<div class="form-group" id="divPasswordCheck">
					<label for="inputPasswordCheck" class="col-lg-2 control-label">변경할
						비밀번호</label>
					<div class="col-lg-5">
						<input type="password" class="form-control" id="passwordCheck"
							name="changePwd" data-rule-required="true" placeholder="패스워드 확인"
							maxlength="30">

					</div>
				</div>
				<div class="form-group" id="divPassword">
					<label for="inputPassword" class="col-lg-2 control-label">변경할
						비밀번호 확인</label>
					<div class="col-lg-5">
						<input type="password" class="form-control" id="password"
							name="confirmChangePwd" data-rule-required="true"
