	...
	<div class="wrapper">
		<div class="container">
			...
			<form:form class="form-horizontal" modelAttribute="member"
				...
				action="${pageContext.request.contextPath}/member/socialAdd">
				<div class="form-group">
					...
					<div class="col-lg-10" id="provision">
						...
						<div class="radio">
							<label>
								<form:checkbox path="provisionYn" /> 동의합니다. <form:errors
									path="provisionYn" />
							</label>
						</div>
					</div>
				...
				<div class="form-group" id="divEmail">
					...
					<div class="col-lg-5">
						<form:input path="email" class="form-control" id="email"
							value="${email }" data-rule-required="true" required="required" />
				...
				<div class="form-group" id="divNickname">
					...
					<div class="col-lg-5">
						<form:input path="nickname" class="form-control" id="nickname"
							value="${nickname }" data-rule-required="true" placeholder="별명"
							maxlength="15" required="required" />
