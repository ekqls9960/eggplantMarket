					...
					<div class="row">
						...
						<div class="col-lg-2 col-sm-3 col-3 order-1">
							<div class="logo_container">
								<div class="logo">
									<a href="/"><img src="/images/eggPlant.png" width=80px
										height=80px></a>
								</div>
							</div>
						</div>
							...
							<div class="header_search">
								<div class="header_search_content">
									<div class="header_search_form_container">
										<form
											action="${pageContext.request.contextPath}/item/search/keyword"
											method="get" class="header_search_form clearfix">
											<input type="search" name="keyword" required="required"
												class="header_search_input" placeholder="상품 검색하기">
						...
						<div
							...
							<div
								...
								<div class="add">
									<a href="${pageContext.request.contextPath}/item/add"><img
										src="/icons/add.png" width=40px height=40px></a>
								</div>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<div class="mypage">
									<a href="${pageContext.request.contextPath}/member/myPage"><img
										src="/icons/mypage.png" width=60px height=60px></a>
								</div>
								&nbsp;&nbsp;&nbsp;
								<div class="shipping">
									<a
										href="${pageContext.request.contextPath}/order/myList/${loginMember.id}"><img
										src="/icons/shipping.png" width=80px height=80px></a>
								</div>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<div class="wish">
									<a href="${pageContext.request.contextPath}/wish/list"><img
										src="/icons/wish.png" width=60px height=60px></a>
								</div>
							</div>
						</div>
					</div>
