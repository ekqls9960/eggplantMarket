								...
								<tbody>
									<c:forEach var="item" items="${myWishItems }">
										<tr>
											<td width="45%">
												<div class="display-flex align-center">
													<div class="img-product">
														<img src="${item.filePath }" alt="" class="mCS_img_loaded"
											...
											<td width="15%">
												<button type="button" class="round-black-btn small-btn"
													onclick="window.location.href='${pageContenxt.request.contextPath}/item/detail/${item.id}'">자세히
													보기</button>
											</td>
											<td width="15%"><button
