...
<body>
	<div class="addContainer">
		<form:form modelAttribute="question"
			action="${pageContext.request.contextPath}/question/edit/${question.id}"
			method="post">
			<h1>문의내용 수정</h1>
			<hr />
			<table class="table table-borderless">
				...
				<tr>
					<th>날짜</th>
					<td><form:input path="currentTime" readonly="true" /></td>
				</tr>
				<tr>
					<th>작성자</th>
				...
				<tr>
					<td colspan="3"><textarea class="summernote" name="content">${question.content }</textarea>
					</td>
				</tr>
			</table>
