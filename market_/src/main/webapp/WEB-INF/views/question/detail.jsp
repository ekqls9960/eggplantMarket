...
<body>
	<div class="addContainer">
		<form:form>
			<h1>
				문의 내용 <input type="button" class="btn btn-primary" value="목록"
					onclick="location.href='/question/list/${question.itemId}'">
			</h1>
			<hr />
			<c:if test="${isAsker}">
				<input type="button" value="수정"
					onclick="location.href='/question/edit/${question.id}'">&nbsp;
				<input type="button" value="삭제"
					onclick="location.href='/question/delete/${question.id}'">
			</c:if>
					...
					<li class="list-group-item d-flex justify-content-between">
						...
						<div class="d-flex">
							...
							<c:if test="${reply_state == 1}">
								<button type="button"
									onclick="location.href='/reply/${list.id}'">삭제</button>
							</c:if>
						</div>
					</li>
				</ul>
