...
public class LoginController {
	...
	@GetMapping("/login")
	public String loginForm(@ModelAttribute("loginFormData") LoginForm form,
			@CookieValue(value = "rememberEmail", required = false) Cookie emailCookie) {
	...
	public String findEmail(@Validated @ModelAttribute("findEmailFormData") FindEmailForm form,
	...
	public String findPwd(@Validated @ModelAttribute("findPwdFormData") FindPwdForm form, BindingResult bindingResult,
			Model model) {
