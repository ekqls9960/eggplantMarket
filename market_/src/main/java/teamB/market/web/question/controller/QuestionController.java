...
//        Member loginMember = (Member) httpSession.getAttribute("loginMember");
	...
	public String add(@Validated @ModelAttribute("question") AddQuestionForm form, BindingResult bindingResult,
		...
		// 성공 로직
		Question question = Question.builder().isReplied(IsReplied.WAIT).content(form.getContent())
				.currentTime(form.getDate()).memberId(loginMember.getId()).writer(loginMember.getNickname())
				.title(form.getTitle()).itemId(itemId).build();
	...
	public String detail(@PathVariable long questionId, @RequestParam(required = false) String content, Model model,
...
//        Member loginMember = (Member) session.getAttribute("loginMember");
	...
	public String edit(@Validated @ModelAttribute("question") EditQuestionForm form, BindingResult bindingResult,
